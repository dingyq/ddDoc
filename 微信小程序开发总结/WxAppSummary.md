...
####MINA 生命周期
![life cycle](./WxAppSummaryRes/wx_app_life_cycle.jpg)
...
![General preferences pane](./WxAppSummaryRes/wx_app_directory.jpg)

####全局配置文件(app.json)
![Global Config](./WxAppSummaryRes/global_config.png)
...
![Data Cache](./WxAppSummaryRes/wx_data_cache.png)
